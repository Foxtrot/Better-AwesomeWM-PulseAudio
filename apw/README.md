Note...
=======
This is a fork of [Mokasins APW](https://github.com/mokasin/apw), without the bar meter and only percentage. Scrolling up and down the volume works, click to mute is represented by turning the text red.

Currently, some of the code is hardcoded such as the color of text and font, however this is still pretty easy to change. (L30, L90-91).
